#!/usr/bin/env python3
"""Abundance-weighted assembly-order distribution

NOTE: GTEx TPM and phenotype files are USER-PROVIDED (download from the GTEx
portal). Set paths at the top of the file. for the VAMP2 fusion state,
